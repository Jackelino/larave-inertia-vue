<template>
    <ul class="navbar-nav iq-main-menu" id="sidebar">
        ...
        <li class="nav-item">
            <router-link
                :class="`nav-link ${
                    checkActive('default.dashboard') ? 'active' : ''
                }`"
                aria-current="page"
        ...
        <li class="nav-item">
            <a
                :class="`nav-link ${checkActive(menustyle) ? 'active' : ''}`"
            ...
            >
                <li class="nav-item">
                    <router-link
                        :class="`nav-link ${
                            checkActive('horizontal.IndexHorizontal')
                                ? 'active'
                                : ''
                        }`"
                        :to="{ name: 'horizontal.IndexHorizontal' }"
                    >
                        <i class="icon">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="nav-item">
                    <router-link
                        :class="`nav-link ${
                            checkActive('dual-horizontal.IndexDualHorizontal')
                                ? 'active'
                                : ''
                        }`"
                        :to="{ name: 'dual-horizontal.IndexDualHorizontal' }"
                    >
                        <i class="icon">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="nav-item">
                    <router-link
                        :class="`nav-link ${
                            checkActive('dual-compact.IndexDualCompact')
                                ? 'active'
                                : ''
                        }`"
                        :to="{ name: 'dual-compact.IndexDualCompact' }"
                    >
                ...
                <li class="nav-item">
                    <router-link
                        :class="`nav-link ${
                            checkActive('boxed.IndexBoxedHorizontal')
                                ? 'active'
                                : ''
                        }`"
                        :to="{ name: 'boxed.IndexBoxedHorizontal' }"
                    >
                        <i class="icon">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="nav-item">
                    <router-link
                        :class="`nav-link ${
                            checkActive('boxedfancy.IndexBoxedFancy')
                                ? 'active'
                                : ''
                        }`"
                        :to="{ name: 'boxedfancy.IndexBoxedFancy' }"
                    >
                        <i class="icon">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
        ...
        <li class="nav-item">
            <router-link
                :class="`nav-link ${
                    checkActive('hope.uisheet') ? 'active' : ''
                }`"
                :to="{ name: 'hope.uisheet' }"
            >
                <i class="icon">
                    <svg
                        width="20"
                ...
                <span
                    >Design System<span class="badge rounded-pill bg-success"
                        >UI</span
                    ></span
                >
            </router-link>
...
export default {
    ...
    data() {
        return {
            menustyle: [
                "horizontal.IndexHorizontal",
                "dual-horizontal.IndexDualHorizontal",
                "dual-compact.IndexDualCompact",
                "boxed.IndexBoxedHorizontal",
                "boxedfancy.IndexBoxedFancy",
            ],
            specialpages: [
                "default.billing",
                "default.calender",
            ...
            maps: ["default.google", "default.vector"],
            forms: ["default.elements", "default.wizard", "default.validation"],
            tables: ["default.bootstraptable", "default.datatable"],
            icons: ["default.solid", "default.outlined", "default.dualtone"],
        };
    },
    methods: {
        checkActive(route) {
